...
import RBSELogo from './assets/education_logo/RBSELogo.jpg';
...
import psdMager from './assets/work_logo/pwdManger.png'
...
export const SkillsInfo = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'React Native + Expo', logo: expo },
      { name: 'FireBase', logo: firebaseLogo },
      { name: 'Figma', logo: figmaLogo },
    ],
  },
  ...
  export const education = [
    ...
    },
    {
      id: 1,
      img: RBSELogo,
      school: "Bright Sr. Sec. School, merta city(Nagaur)",
      date: "Apr 2021 - March 2022",
      grade: "71.8%",
      desc: "I completed my class 12 education from Bright Sr. Sec. School, merta city, under the RBSE board, where I studied Physics, Chemistry, and Mathematics (PCM) with Computer Science.",
    ...
    },
    {
      ...
      grade: "71.5%",
      desc: "I completed my class 10 education from Bright Sr. Sec. School, merta city, under the RBSE board.",
      degree: "RBSE(X)",
    },
  ];
